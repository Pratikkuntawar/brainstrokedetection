      ...
      <nav className=" navb navbar navbar-expand-lg navbar-dark bg-danger bg-opacity-0 px-4">
        ...
        >
          <ul className="navbar-nav ms-auto gap-4">
            ...
            <li className="nav-item">
              <NavLink className="nav-link text-white nav-hover" to="/upload" activeClassName="active" onClick={closeNavbar}>
                Upload
              </NavLink>
            </li>
            <li className="nav-item">
              <NavLink className="nav-link text-white nav-hover" to="/faq" activeClassName="active" onClick={closeNavbar}>
                FAQ
              </NavLink>
            </li>
          </ul>
